  ...
  useEffect(() => {
    ...
    fetch("http://localhost:8081/api/dashboard", {
      ...
      .then((response) => {
        if (!response.ok) {
          throw new Error(
            "Failed to fetch dashboard data. Check permissions (403) or network.",
          );
        }
              ...
              <div className="d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <h2 className="mb-0 fw-bold text-warning">
                    {dashboardData.pendingApprovalCount}
                  </h2>
                </div>
                <i
                    ...
                    {dashboardData.recentBatches.map((batch) => (
                      ...
                      <tr key={batch.batchId}>
                        ...
                        */}
                        ...
                        <td className="fw-semibold">{batch.amount} </td>
                        <td>
                          <span
        ...
        <div className="container-fluid px-5">
          <div className="row">
            <div className="col-md-4 mb-4 mb-md-0">
              ...
              >
                Delivering trusted financial services that connect people,
                ideas, and opportunities worldwide.{" "}
              </p>
            </div>
