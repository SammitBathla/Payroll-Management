          ...
          <div className="row align-items-center min-vh-75">
            <div className="col-lg-6">
              <h1 className="display-4 fw-bold mb-4">
                Streamline Your <span className="text-success">Payroll</span>{" "}
                Operations
              </h1>
              <p className="lead text-muted mb-4">
                Experience seamless payroll management with automated batch
                processing, multi-currency support, and enterprise-grade
                approval workflows.
              </p>
              ...
              <div className="card border-0 shadow-sm h-100 hover-lift">
                <div className="card-body p-4">
                  ...
                  <p className="text-muted">
                    Process multiple employee payments in a single batch with
                    manual entry or Excel file upload.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              <div className="card border-0 shadow-sm h-100 hover-lift">
                <div className="card-body p-4">
                  ...
                  <p className="text-muted">
                    Support for domestic (INR) and foreign currency payments
                    (USD, EUR) with real-time exchange rates.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              <div className="card border-0 shadow-sm h-100 hover-lift">
                <div className="card-body p-4">
                  ...
                  <p className="text-muted">
                    Multi-level approval system based on payment amount with
            ...
            <div className="col-md-4">
              <div className="card border-0 shadow-sm h-100 hover-lift">
                <div className="card-body p-4">
                  ...
                  <p className="text-muted">
                    Monitor batch status, payment history, and account balance
            ...
            <div className="col-md-4">
              <div className="card border-0 shadow-sm h-100 hover-lift">
                <div className="card-body p-4">
                  ...
                  <p className="text-muted">
                    Comprehensive reporting with payment statements, audit
                    trails, and export capabilities.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              <div className="card border-0 shadow-sm h-100 hover-lift">
                <div className="card-body p-4">
                  ...
                  <p className="text-muted">
                    Bank-grade security with role-based access, audit logs, and
          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 ps-lg-5">
              ...
              <p className="text-muted mb-4">
                Our payroll management system is designed specifically for
                enterprise organizations requiring robust batch processing,
                multi-currency support, and complex approval workflows.
              </p>
              <ul className="list-unstyled">
                <li className="mb-3">
                  ...
                  <strong>Automated Processing:</strong> Reduce manual errors
                  with automated batch creation and validation
                </li>
                <li className="mb-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <strong>Scalable Architecture:</strong> Process thousands of
                  payments efficiently with Spring Boot backend
                </li>
                <li className="mb-3">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <strong>Comprehensive Audit Trail:</strong> Track every action
                  with detailed logs for compliance
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="bg-success text-white py-5">
        <div className="container py-5 text-center">
          ...
          <p className="lead mb-4">
            Join leading organizations using our platform for efficient payroll
            management
          </p>
          <button
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-4 mb-4">
              ...
              <p className="text-muted">
                Enterprise-grade payroll processing with multi-currency support
